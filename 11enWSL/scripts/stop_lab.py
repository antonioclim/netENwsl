...
def build_argument_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description="Stop Week 11 Laboratory Environment (WSL2)",
...
def main() -> int:
    ...
    # ─── DISPLAY_BANNER ───────────────────────────────────────────────────────
    logger.info("=" * 60)
    logger.info("Stopping Week 11 Laboratory Environment")
    ...
    try:
        ...
        containers = ["s11_nginx_lb", "s11_backend_1", "s11_backend_2", "s11_backend_3"]
    ...
    try:
        ...
        if running:
            ...
            logger.info("  All week11 containers stopped")
