...
PREDICTION PROMPTS:
  💭 Before A query: How many bytes will the encoded domain "www.google.com" take?
  💭 Before MX query: Will MX records include priority values?
  💭 Before querying non-existent domain: What RCODE will you receive?
