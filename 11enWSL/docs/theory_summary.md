...
> 💡 **Tip:** Before examining technical details, see [`docs/concept_analogies.md`](concept_analogies.md) for everyday analogies that make these concepts more intuitive.
...
**Least Connections**
Routes to the server with fewest active connections. Best when requests have heterogeneous processing times. Requires connection tracking overhead.
...
- `docs/misconceptions.md` — Common misunderstandings about these protocols
- `docs/glossary.md` — Technical terms and definitions
- `docs/peer_instruction.md` — Quiz questions for self-assessment
