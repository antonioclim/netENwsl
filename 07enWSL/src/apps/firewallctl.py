...
This tool applies small iptables rule profiles from `docker/configs/firewall_profiles.json`.
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--profile", required=True, help="Profile name from docker/configs/firewall_profiles.json")
