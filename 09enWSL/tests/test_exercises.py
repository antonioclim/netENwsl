...
def test_exercise_2_pseudo_ftp() -> bool:
    ...
    script_path = PROJECT_ROOT / "src" / "exercises" / "ex_9_02_implement_pseudo_ftp.py"
...
# TEST_VERIFICATION
# ═══════════════════════════════════════════════════════════════════════════════
def test_ex_9_03_ftp_client_demo() -> bool:
    """Test FTP demo client script."""
    print("\n" + "=" * 50)
    print("FTP Demo Client")
    print("=" * 50)
    
    script_path = PROJECT_ROOT / "src" / "exercises" / "ex_9_03_ftp_client_demo.py"
    
    if not script_path.exists():
        print("  SKIP: ex_9_03_ftp_client_demo.py not found")
        return True
...
def main() -> int:
    ...
    if args.exercise is None or args.exercise == 2:
        ...
        results.append(test_ex_9_03_ftp_client_demo())
