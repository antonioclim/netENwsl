...
for the Week 9 Session Layer and Presentation Layer laboratory.
"""
...
# ═══════════════════════════════════════════════════════════════════════════════
    def summary(self) -> int:
        ...
        if self.failed == 0:
            print("\033[92m✓ Environment is ready for Week 9 laboratory!\033[0m")
            print()
            print("Next steps:")
            print("  1. Start the lab: python3 scripts/start_lab.py")
            print("  2. Test FTP:      python3 src/exercises/ftp_demo_client.py --host localhost --port 2121")
            print("  3. Run demo:      python3 scripts/run_demo.py --demo ftp_session")
            print()
            print("Access points:")
            print("  Portainer:     http://localhost:9000 (stud/studstudstud)")
            print("  FTP Server:    localhost:2121 (test/12345)")
            print("  Passive Ports: 60000-60010")
            return 0
        else:
...
def main() -> int:
    ...
    print("  Session Layer and Presentation Layer")
    ...
    # Check struct module (always available in Python)
    c.check("Python struct module", True)
    ...
    required_files = [
        ...
        "src/exercises/ex_9_02_pseudo_ftp.py",
        "src/exercises/ftp_demo_client.py",
        "src/exercises/ftp_demo_server.py",
    ]
