#!/usr/bin/env python3
"""
Exercise 9.02 – Implement Pseudo-FTP Server/Client with Session and Presentation
================================================================================
Computer Networks - Week 9 (WSL Environment)
ASE Bucharest | by ing. dr. Antonio Clim

═══════════════════════════════════════════════════════════════════════════════
💭 PREDICTION PROMPTS (Answer before running the code)
═══════════════════════════════════════════════════════════════════════════════
Before running this implementation, predict:

1. What response code does FTP-like protocols use for successful login?
   Hint: Think about HTTP status codes in the 2xx range.

2. How many TCP connections does this pseudo-FTP use simultaneously?
   Hint: Consider control vs data channels.

3. What happens if you send PASSIVE_GET before USER/PASS authentication?
   Hint: What should a secure server respond?

4. In passive mode, who initiates the data connection - client or server?
   Hint: Think about firewall implications.

5. What is the purpose of the CRC32 in the binary header?
   Hint: Consider data integrity during transfer.

Write your predictions, then verify by running the server and client!

═══════════════════════════════════════════════════════════════════════════════
OBJECTIVES (Anderson-Bloom Taxonomy)
═══════════════════════════════════════════════════════════════════════════════
1. UNDERSTAND session concepts (L5): authentication, state, CWD
2. APPLY presentation concepts (L6): binary header, compression
3. ANALYSE the separation of control and data channels (similar to FTP)
4. DIFFERENTIATE active/passive modes for data transfer
...
# Server
python3 ex_9_02_implement_pseudo_ftp.py server --host 127.0.0.1 --port 3333 --root ./server-files

# Client - individual commands
python3 ex_9_02_implement_pseudo_ftp.py client --host 127.0.0.1 --port 3333 --user test --password 12345 list
python3 ex_9_02_implement_pseudo_ftp.py client ... get hello.txt
python3 ex_9_02_implement_pseudo_ftp.py client ... put myfile.txt

# Client - interactive
python3 ex_9_02_implement_pseudo_ftp.py client ... --interactive
"""
