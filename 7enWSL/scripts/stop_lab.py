...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(
        description="Stop Week 7 Laboratory Environment (WSL2)",
...
Notes:
  ...
  - Portainer is a global service that should remain running
    ...
    try:
        ...
        containers = ["week7_tcp_server", "week7_tcp_client", "week7_udp_receiver",
                     "week7_udp_sender", "week7_packet_filter"]
    ...
    try:
        ...
        if running:
            ...
            logger.info("  All week7 containers stopped")
