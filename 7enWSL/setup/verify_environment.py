...
for the Week 7 Packet Interception, Filtering and Port Probing laboratory.
"""
...
class Checker:
    ...
    def summary(self) -> int:
        ...
        if self.failed == 0:
            print("\033[92m✓ Environment is ready for Week 7 laboratory!\033[0m")
            print()
            print("Next steps:")
            print("  1. Start the lab: python3 scripts/start_lab.py")
            print("  2. Run baseline:  python3 scripts/run_demo.py --demo baseline")
            print("  3. Try filtering: python3 src/apps/firewallctl.py --profile block_tcp_9090")
            print()
            print("Access points:")
...
def main() -> int:
    ...
    print("  Packet Interception, Filtering & Port Probing")
    ...
    if check_command_exists("tcpdump"):
        ...
        c.warn("tcpdump", "Install: sudo apt install tcpdump")
    
    if check_command_exists("tshark"):
        c.check("tshark: Available", True)
    else:
        c.warn("tshark", "Install: sudo apt install tshark")
    
    # Check iptables
    if check_command_exists("iptables"):
        c.check("iptables: Available", True)
    else:
        c.warn("iptables", "Install: sudo apt install iptables")
