...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(
        description="Stop Week 9 Laboratory Environment (WSL2)",
...
Notes:
  ...
  - Portainer is a global service that should remain running
    ...
    logger.info("=" * 60)
    logger.info("Stopping Week 9 Laboratory Environment")
    ...
    try:
        ...
        containers = ["s9_ftp_server", "s9_client1", "s9_client2"]
    ...
    try:
        ...
        if running:
            ...
            logger.info("  All week9 containers stopped")
