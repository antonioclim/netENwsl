...
for the Week 12 Email Protocols and RPC laboratory.
"""
...
class Checker:
    ...
    def summary(self) -> int:
        ...
        if self.failed == 0:
            print("\033[92m✓ Environment is ready for Week 12 laboratory!\033[0m")
            print()
            print("Next steps:")
            print("  1. Start the lab: python3 scripts/start_lab.py")
            print("  2. Test SMTP:     nc localhost 1025")
            print("  3. Test RPC:      curl http://localhost:6200")
            print()
            print("Access points:")
...
# ═══════════════════════════════════════════════════════════════════════════════
# CHECK_PORTAINER_RUNNING_FUNCTION
# ═══════════════════════════════════════════════════════════════════════════════
...
def main() -> int:
    ...
    print("  Email Protocols (SMTP) and RPC")
    ...
    required_files = [
        ...
        "docker/Dockerfile",
        "src/apps/email/smtp_server.py",
        "src/apps/rpc/jsonrpc/jsonrpc_server.py",
        "src/apps/rpc/xmlrpc/xmlrpc_server.py",
        "src/apps/rpc/grpc/grpc_server.py",
    ]
