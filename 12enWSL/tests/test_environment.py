...
class TestProjectStructure:
    ...
    def test_smtp_server_exists(self):
    ...
    def test_jsonrpc_server_exists(self):
...
class TestPortAvailability:
    ...
    def test_smtp_port_or_available(self, check_port):
    ...
    def test_jsonrpc_port_or_available(self, check_port):
