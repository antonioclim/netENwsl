...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(
        description="Stop Week 12 Laboratory Environment (WSL2)",
  ...
  - Portainer is a global service that should remain running
    ...
    try:
        ...
        if running:
            ...
            logger.info("  All week12 containers stopped")
        ...
        logger.info(f"  Spool:     {PROJECT_ROOT / 'docker/volumes/spool'}")
