...
class SMTPTester:
    ...
    def quick_test(self) -> bool:
        ...
        try:
            ...
            quit = self.send_command("QUIT")
            self.logger.info(f"QUIT: {quit.code}")
            
            self.close()
            return greeting.code == 220 and quit.code == 221
...
class JSONRPCTester:
    ...
    def __init__(self, url: str = "http://127.0.0.1:6200"):
        self.url = url
...
class XMLRPCTester:
    ...
    def __init__(self, url: str = "http://127.0.0.1:6201"):
        self.url = url
