...
class WeightedLoadBalancer:
    ...
    # 💭 PREDICTION: With weights 5:3:1, how many requests should each backend
    ...
    # 💭 PREDICTION: What happens if a health check takes too long?
    ...
    # 💭 PREDICTION: What should happen if the selected backend fails mid-request?
