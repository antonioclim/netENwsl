...
**Linked Artefacts:**
- 📚 Theory: `00BEFORE_ANYTHING_ELSE/Prerequisites.md` sections 4-7
- 🔬 Practice: `00BEFORE_ANYTHING_ELSE/verify_lab_environment.sh`
...
**Linked Artefacts:**
- 📚 Theory: `00BEFORE_ANYTHING_ELSE/Prerequisites.md` section 2.1
...
**Linked Artefacts:**
- 📚 Theory: `00BEFORE_ANYTHING_ELSE/Prerequisites.md` section 2.3
