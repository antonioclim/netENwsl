...
# SHUTDOWN_LOGIC
# ═══════════════════════════════════════════════════════════════════════════════
def stop_containers_direct(force: bool, timeout: int) -> None:
    """Stop containers directly when compose file not found."""
...
def main() -> int:
    ...
    try:
        ...
        stop_containers_direct(args.force, args.timeout)
        return 0
