...
### Kit integrity checks

From the Week 14 root folder:

```bash
python3 scripts/validate_kit.py --quick
```

For a more thorough validation (includes security and documentation checks):
...
Some tests are **integration-style** and require the Week 14 Docker lab to be running. These are disabled by default. To enable them:

```bash
RUN_DOCKER_TESTS=1 python3 -m pytest
```

### Anti-AI formative verification

The formative anti-AI verifier is available via:

```bash
make quiz-verify
```

If the environment is verified a report and certificate are saved under:
...
This laboratory session serves as a complete review and integration of concepts covered throughout the Computer Networks course. The practical focus centres on building and validating a complete network topology that incorporates multiple services communicating across a containerised environment.
...
This automated demonstration exercises all system components and generates a full report.
...
This week includes additional learning resources designed using evidence-based teaching methods.

### Available Resources

| Resource | Location | Description |
|----------|----------|-------------|
| Peer Instruction | `docs/peer_instruction.md` | 5 MCQ questions with misconception analysis |
| Pair Programming | `docs/pair_programming_guide.md` | Collaborative exercise structure |
| Misconceptions | `docs/misconceptions.md` | 14 common misconceptions with corrections |
| Glossary | `docs/glossary.md` | Technical terms and definitions |
| Code Tracing | `docs/code_tracing.md` | 5 code tracing exercises |
| Parsons Problems | `docs/parsons_problems.md` | 5 code reordering exercises |
| Concept Analogies | `docs/concept_analogies.md` | 8 CPA concrete phase analogies |
