...
def test_dns_query(server: str, port: int, domain: str = "web.lab.local") -> tuple[bool, str]:
    """
...
def run_tests() -> int:
    ...
    for test in TESTS:
        ...
        if test_type == "tcp":
            ...
            success, message = test_udp_port(host, port)
        else:
    ...
    if failed > 0:
        ...
        print("  python3 src/exercises/ex_10_01_https.py serve")
