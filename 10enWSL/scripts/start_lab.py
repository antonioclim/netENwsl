...
def print_banner() -> None:
    ...
    print()
    print("=" * 65)
    print("  Week 10: Application Layer Protocols")
    print("  HTTP/HTTPS, REST, DNS, SSH, FTP")
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(
        description="Start Week 10 Laboratory Environment (WSL2)",
  ...
  - Credentials: stud / studstudstud
    ...
    try:
        ...
        if all_healthy:
            ...
            print("    dig @127.0.0.1 -p 5353 web.lab.local +short")
