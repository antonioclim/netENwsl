...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(
        description="Stop Week 10 Laboratory Environment (WSL2)",
...
Notes:
  ...
  - Portainer is a global service that should remain running
    ...
    try:
        ...
        containers = ["week10_web", "week10_dns", "week10_ssh", "week10_ssh_client",
                     "week10_ftp", "week10_debug"]
    ...
    try:
        ...
        if running:
            ...
            logger.info("  All week10 containers stopped")
