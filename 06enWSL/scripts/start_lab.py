...
Usage:
    python scripts/start_lab.py              # Start lab environment
    python scripts/start_lab.py --status     # Check status only
    python scripts/start_lab.py --rebuild    # Rebuild and start
"""
...
def print_access_info(services_started: dict) -> None:
