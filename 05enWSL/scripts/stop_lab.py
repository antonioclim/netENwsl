...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description="Stop Week 5 Laboratory Environment (WSL2)",
...
def main() -> int:
    """
    Main entry point for the laboratory shutdown.
    ...
    try:
        ...
        containers = ["week5_python", "week5_udp-server", "week5_udp-client"]
    ...
    try:
        ...
        if running:
            ...
            logger.info("  All week5 containers stopped")
