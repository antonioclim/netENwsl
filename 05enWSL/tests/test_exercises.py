...
# TEST_VERIFICATION
# ═══════════════════════════════════════════════════════════════════════════════
    def test_analyze_prefix_24(self) -> bool:
...
# TEST_VERIFICATION
# ═══════════════════════════════════════════════════════════════════════════════
    def test_network_address_type(self) -> bool:
...
# TEST_VERIFICATION
# ═══════════════════════════════════════════════════════════════════════════════
    def test_broadcast_address_type(self) -> bool:
...
# TEST_VERIFICATION
# ═══════════════════════════════════════════════════════════════════════════════
    def test_flsm_split_4(self) -> bool:
...
# TEST_VERIFICATION
# ═══════════════════════════════════════════════════════════════════════════════
    def test_flsm_split_8(self) -> bool:
...
# TEST_VERIFICATION
# ═══════════════════════════════════════════════════════════════════════════════
    def test_flsm_invalid_count(self) -> bool:
...
# TEST_VERIFICATION
# ═══════════════════════════════════════════════════════════════════════════════
    def test_vlsm_efficiency(self) -> bool:
        """Test VLSM allocates best prefix lengths."""
...
# TEST_VERIFICATION
# ═══════════════════════════════════════════════════════════════════════════════
    def test_vlsm_insufficient_space(self) -> bool:
...
# TEST_VERIFICATION
# ═══════════════════════════════════════════════════════════════════════════════
    def test_ipv6_compress(self) -> bool:
...
# TEST_VERIFICATION
# ═══════════════════════════════════════════════════════════════════════════════
    def test_ipv6_expand(self) -> bool:
        """Test IPv6 expansion."""
...
# TEST_VERIFICATION
# ═══════════════════════════════════════════════════════════════════════════════
    def test_prefix_for_hosts(self) -> bool:
...
# TEST_VERIFICATION
# ═══════════════════════════════════════════════════════════════════════════════
    def test_prefix_to_netmask(self) -> bool:
...
# EXECUTE_OPERATION
# ═══════════════════════════════════════════════════════════════════════════════
def run_exercise_tests(exercise_num: int = None) -> None:
