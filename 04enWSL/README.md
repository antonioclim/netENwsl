...
2. **Explain** the distinction between text and binary protocols, explaining the trade-offs in overhead, parsing complexity and human readability
...
> 💭 **PREDICTION:** Before starting, predict: If you send "HELLO" then "WORLD" via TCP, will the server receive them as two separate messages?
...
> 💭 **PREDICTION:** If the sender uses big-endian and receiver expects little-endian, what happens to the value 1000?
...
This laboratory kit includes evidence-based teaching materials in the `docs/` folder:

| Resource | Purpose | When to Use |
|----------|---------|-------------|
| `peer_instruction.md` | 5 MCQ questions with misconception analysis | During seminar, vote-discuss-revote |
| `pair_programming_guide.md` | Driver/Navigator collaboration guide | For paired exercises |
| `misconceptions.md` | 8 common errors and corrections | When debugging or confused |
| `glossary.md` | Technical terms and definitions | Quick reference |
| `code_tracing.md` | Trace execution exercises | Before writing code |
| `parsons_problems.md` | Reorder code blocks | Practice without blank page |
| `concept_analogies.md` | Real-world analogies for concepts | Before technical details |

### Recommended Learning Path

1. **Before lab:** Read `concept_analogies.md` for intuition
2. **Start of lab:** Instructor uses `peer_instruction.md` questions
3. **During exercises:** Follow `pair_programming_guide.md` with partner
4. **When stuck:** Check `misconceptions.md` and `glossary.md`
5. **After lab:** Complete `code_tracing.md` and `parsons_problems.md`
