...
# Portainer is NOT included - it runs globally on port 9000
...
def start_services(docker: DockerManager, args: argparse.Namespace) -> bool:
    """
    Start all laboratory services.
...
def display_success_message(portainer_running: bool) -> None:
...
def main() -> int:
    ...
    # ─────────────────────────────────────────────────────────────────────────
    # Step 4: Handle status-only request
    # ─────────────────────────────────────────────────────────────────────────
    if args.status:
        print_banner()
    ...
    # ─────────────────────────────────────────────────────────────────────────
    try:
        if not start_services(docker, args):
            return 1
        ...
        if all_healthy:
            display_success_message(portainer_running)
            return 0
        else:
